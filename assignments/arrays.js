...
// The car dealer has all of their inventory housed in the array seen below.  Scroll down past the data to find out how you can help
// the car dealer.
...
for (var i=0; i < inventory.length; i++) {
    ...
    car33 = [inventory[i].car_year, inventory[i].car_make, inventory[i].car_model]
    }
}
console.log(`Car 33 is a ${car33[0]} ${car33[1]} ${car33[2]}.`);
...
console.log(lastCar[0], lastCar[1]);
